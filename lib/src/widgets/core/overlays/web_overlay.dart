                      ...
                      children: [
                        ...
                        GetBuilder<PodGetXVideoController>(
                          ...
                          builder: (podCtr) => MaterialIconButton(
                            toolTipMesg: podCtr.isMute ? podCtr.podPlayerLabels.unmute ?? 'Unmute${kIsWeb ? ' (m)' : ''}' : podCtr.podPlayerLabels.mute ?? 'Mute${kIsWeb ? ' (m)' : ''}',
                            color: itemColor,
                  ...
                  child: FittedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        MaterialIconButton(
                          toolTipMesg: podCtr.isFullScreen ? podCtr.podPlayerLabels.exitFullScreen ?? 'Exit full screen${kIsWeb ? ' (f)' : ''}' : podCtr.podPlayerLabels.fullscreen ?? 'Fullscreen${kIsWeb ? ' (f)' : ''}',
                          color: itemColor,
    ...
    if (podCtr.isOverlayVisible) {
      if (podCtr.isFullScreen) {
        ...
        if (kIsWeb) {
          ...
          podCtr.enableFullScreen(tag, showMenu: podCtr.showMenu);
          return;
        } else {
          podCtr.enableFullScreen(tag, showMenu: podCtr.showMenu);
        }
